...
const Periode = () => {
  ...
  const handleSubmit = (data) => {
    //setShowModal(true)
    toast.promise(request.post(endPoint.periodes, data, header), {
  ...
  const handleEditSubmit = (data) => {
    toast.promise(request.post(endPoint.periodes + "/" + editId, data, header), {
      pending: "Veuillez patienté...",
      success: {
        render({ data }) {
          console.log(data);
  ...
  const onDelete = () => {
    toast.promise(
      request.delete(endPoint.periodes + "/" + viewData.slug, header),
      {
        pending: "Veuillez patienté...",
        success: {
          render({ data }) {
      ...
      <div className="modal fade" id="view">
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div>
                <span className="fw-bold d-inline-block me-2">Periode : </span>
